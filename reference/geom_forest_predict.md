...
`geom_forest_predict()` draws a prediction interval around a
random-effects summary estimate. The prediction interval is wider than
the confidence interval and represents the range where the true effect
in a new study is expected to fall.
...
- cap_width:
  ...
  Width of the capped end-marks as a proportion of row spacing. Default:
  `0.32`.
